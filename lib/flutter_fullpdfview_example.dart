...
class FlutterFullpdfviewExample extends StatefulWidget {
  @override
  _FlutterFullpdfviewExampleState createState() =>
      _FlutterFullpdfviewExampleState();
}

class _FlutterFullpdfviewExampleState extends State<FlutterFullpdfviewExample> {
  String pathPDF = "";
  ...
  void initState() {
    super.initState();
    fromAsset('assets/doj-fhwa-ta-glossary.pdf', 'doj-fhwa-ta-glossary.pdf')
        .then((f) {
      setState(() {
