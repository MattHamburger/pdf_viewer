...
class PdfPreviewerExample extends StatefulWidget {
  @override
  _PdfPreviewerExampleState createState() => new _PdfPreviewerExampleState();
}

class _PdfPreviewerExampleState extends State<PdfPreviewerExample> {
  String _pdfPath = '';
  String _previewPath;
  ...
  void _pickPDF() async {
    try {
      _pdfPath = await FilePicker.getFilePath(type: FileType.any);
      setState(() {});
      if (_pdfPath == '') {
        return;
      }
