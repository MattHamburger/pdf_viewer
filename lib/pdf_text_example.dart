...
class PdfTextExample extends StatefulWidget {
  @override
  _PdfTextExampleState createState() => _PdfTextExampleState();
}

class _PdfTextExampleState extends State<PdfTextExample> {
  PDFDoc _pdfDoc;
  String _text = "";
