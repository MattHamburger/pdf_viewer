...
class ReadPdfTextExample extends StatefulWidget {
  @override
  _ReadPdfTextExampleState createState() => _ReadPdfTextExampleState();
}

// Example class for pdf text reader plugin
class _ReadPdfTextExampleState extends State<ReadPdfTextExample> {
  String _pdfText = '';
